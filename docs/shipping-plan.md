...
### Frontend & Tracking
- [ ] **Zone Occupancy Tracking**: Real-time frontend tracking of current count within a zone.

### Analytics & Reporting
- [ ] **Peak Hours Identification**: Pinpoint and visualize the busiest times within zones.

### Live Dashboard
- [ ] **Multi-camera Grid (2x2, 3x3)**: Allow users to view multiple camera streams simultaneously.
- [ ] **Real-time Zone Counts Overlay**: Display live counting metrics directly over the video feeds.
- [ ] **Current Occupancy Display**: High-level dashboard widget showing total current occupancy.
...
- [ ] **Real-time Data Streaming (WebSocket/SSE)**: Live, zero-latency dashboard updates as events happen.
